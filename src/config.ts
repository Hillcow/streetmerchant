...
const notifications = {
	...
	discord: {
		...
		notifyGroupSeries: {
			...
			psportal: envOrArray(process.env.DISCORD_NOTIFY_GROUP_PSPORTAL),
			...
			sonyps5cslim: envOrArray(process.env.DISCORD_NOTIFY_GROUP_SONYPS5CSLIM),
			sonyps5deslim: envOrArray(process.env.DISCORD_NOTIFY_GROUP_SONYPS5DESLIM),
...
const proxy = {
	...
	own: envOrNumber(process.env.PROXY_OWN, 0)
};
...
const store = {
	...
	maxPrice: {
      ...
      psportal: envOrNumber(process.env.MAX_PRICE_SERIES_PSPORTAL),
			...
			sonyps5cslim: envOrNumber(process.env.MAX_PRICE_SERIES_SONYPS5CSLIM),
			sonyps5deslim: envOrNumber(process.env.MAX_PRICE_SERIES_SONYPS5DESLIM),
